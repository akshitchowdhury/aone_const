            ...
            <div className="bg-gray-50 rounded-lg shadow-md overflow-hidden flex flex-col justify-center
             items-center h-full p-6 hover:bg-zinc-950 text-gray-800 hover:text-white duration-300 transition ease-in-out ">
              ...
              <div className="p-6 flex flex-col flex-1 text-justify">
                ...
                <p className="">
                  Adhya Builder's is a leading provider of Infrastructure Services, Construction, Interior Designing and Property developments. We are committed to delivering for communities and leaving lasting legacies through our work.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-red-600 rounded-lg shadow-md overflow-hidden flex flex-col justify-center
             items-center h-full p-6 hover:bg-zinc-950 text-white hover:text-white duration-300 transition ease-in-out">
              ...
              <div className="p-6 flex flex-col flex-1 text-justify">
                ...
                <p className="">
                  Adhya Builders offers its customers everything they need to effortlessly plan and carry out building projects more quickly than ever before, including 3D drawings, floor plans, engineering support, and site inspection.
                </p>
              </div>
            </div>
          </div>
